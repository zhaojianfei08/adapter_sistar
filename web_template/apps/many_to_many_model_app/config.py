...
# "一"方对应的Model, 一方对应的模型
MANY_SIDE_A_MODEL_NAME = A
# “多”方对应的Model，多方对应的模型
MANY_SIDE_B_MODEL_NAME = B
# 基于哪个字段筛选
...
MANY_SIDE_A_FORM_INFO = {
    "name": "User",  # 模型名
    "api_name": "ur/api/user",  # 对应的API 增加  修改  删除要用，需要考虑 蓝图前缀,还有ONE_SIDE_API_NAME后面的s去掉
    "columns": {  # 需要渲染的列
        'name': {  # name列
...
MANY_SIDE_A_FORM_INFO_VALIDATE = {
    "column_list": ['name', 'roles'],  # 校验，模型类必传项目中，必须列入到column_list中
